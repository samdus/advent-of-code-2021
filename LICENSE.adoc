//La version orginale de ce fichier est disponible sous https://depot.griis.usherbrooke.ca/USoutien/common/gradle-plugin-griis/tree/dev/src/main/resources/config/license
